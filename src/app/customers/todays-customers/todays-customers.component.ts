...
@Component({
  selector: 'app-todays-customers',
  templateUrl: './todays-customers.component.html',
  styleUrls: ['./todays-customers.component.scss'],
  providers: [CustomersService]
})
export class TodaysCustomersComponent implements OnInit {
  public data: any = [];
